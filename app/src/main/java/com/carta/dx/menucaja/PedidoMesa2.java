...
public class PedidoMesa2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout. content_pedido_mesa2);

        final TextView preparacion3= (TextView)findViewById(R.id.textoM3);
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for (int i = 0; i < pedido.length(); i++) {
                        ...
                        preparacion3.setText(producto + " " + " "  +precio+ "");
