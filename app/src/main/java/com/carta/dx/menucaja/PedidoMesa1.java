...
public class PedidoMesa1 extends AppCompatActivity {
    ...
    @Override
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.content_pedido_mesa1);

      //      Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
          //  setSupportActionBar(toolbar);

            final TextView preparacion1= (TextView)findViewById(R.id.textoM1);
                ...
                public void onResponse(JSONObject response) {
                    /*try {
                        ...
                        for (int i = 0; i < pedido.length(); i++) {
                            ...
                            preparacion1.setText(producto +  " ");
                            preparacion2.setText(precio +  " ");
                        }
                    ...
                    try {
                        ...
                        String precio = pedido.getString("Valor");
